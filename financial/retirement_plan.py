...
class Retirement:
    ...
    def __init__(
        ...
        self.expense_monthly_pension_couple = ***REMOVED***0

        ## INCOME/SAVING
        self.income_monthly = ***REMOVED***0
        self.saving = ***REMOVED***
        self.income_monthly_spouse = ***REMOVED***
        self.max_income_monthly = ***REMOVED***
